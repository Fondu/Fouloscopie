classdef Robot < handle
    ...
    methods
        ...
        function robot = Robot(id, x, y, orientation , SPEED)
            ...
            robot.yLen = 1.6;
            robot.id = id;
            robot.gridX=mod(id-1,4);
            robot.gridY=floor((id-1)/4);
            robot.reckonXmin = 0.1+(robot.gridX*(robot.xLen/4))-(robot.xLen/2);
            robot.reckonYmin = 0+(robot.gridY*(robot.yLen/3))-(robot.yLen/2);
            robot.reckonPosition = 0;
            robot.reckonLoop = 1;
            robot.x = x;
            robot.y = y;
            robot.xMove = 0;
            ...
            robot.info_transmitted = 0;
            robot.transmition_index = 0;
        ...
        function robot = set_info_cible(robot, cible_x, cible_y, trans_ind)
            ...
            % à un autre robot voisin. 
                ...
                robot.transmition_index = trans_ind;
        end   
